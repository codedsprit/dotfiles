...
const char *spcmd4[] = {"st", "-n", "spterm2", "-g", "120x34", NULL };
...
static const Rule rules[] = {
	...
	{ NULL,		  "spterm3",	NULL,		SPTAG(3),		1,			0,			0,		-1 },
};
...
static const char *searchmenu[] = { "/bin/bash", "-c", "/usr/local/bin/dmenu-websearch.sh", NULL };
/* commands */
